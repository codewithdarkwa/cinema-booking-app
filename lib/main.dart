...
class _BookingPageState extends State<BookingPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => _scrollToSelectedIndex());
    super.initState();
  }
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: List.generate(
                      ...
                      (index) {
                        final randomColor =
                            getRandomColor([const Color(0xFF2A2F30), Colors.white, const Color(0xffE03B1A)]);
                        return Icon(
                          Icons.chair,
                          color: randomColor,
                        );
                      ...
                      children: [
                        const Row(
                          ...
                          children: [
                            ...
                            Text("SmartCinema Sky Park", style: TextStyle(color: Colors.white),),
                          ],
                        ),
                        const Text(
